package com.example.odm.webservice50.Main;
...
import com.example.odm.webservice50.Tablas.Acerca_de_Activity;
...
import com.example.odm.webservice50.Tablas.chprivado.ChatPrivadoFragment;
...
public class MainMenuActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_acercade) {
            Intent intent = new Intent(this, Acerca_de_Activity.class);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case 1:
                    return ChatPublicoFragment.newInstance();
                case 2:
                    return ChatPrivadoFragment.newInstance();
            }
            return null;
        }
